...
import { EventGameType, VoucherEventType } from "@/schema/event.schema";
...
const UpdateEventForm = ({ event, back }: { event: EventGameType; back: (refetchData?: boolean) => void }) => {
    ...
    const [vouchers, setVouchers] = useState<VoucherEventType[]>(event.vouchers);
    const [errorVouchers, setErrorVouchers] = useState("");
    const [startTime, setStartTime] = useState(event.startTime);
    const [errorStartTime, setErrorStartTime] = useState("");
    const [endTime, setEndTime] = useState(event.endTime);
    const [errorEndTime, setErrorEndTime] = useState("");
    const [games, setGames] = useState<GameType[]>(event.games);
        ...
        <>
            ...
            >
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div className="image">
                        ...
                        <img
                            ...
                            alt="your image"
                            className="mt-2 w-[90vw] sm:max-w-80 xl:max-w-96 max-h-80 object-cover mx-auto border rounded-md"
                        />
                ...
                <div className="!mt-6 flex justify-center items-center gap-5 ">
                    <Button className="text-base cancel-btn-color" onClick={() => back()}>
                        Cancel
                    </Button>
